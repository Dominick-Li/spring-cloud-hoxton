...
@REM -----------------------------------------------------------------------------
@REM Start script for the configuration Server
@REM -----------------------------------------------------------------------------
...
set SERVER_NAME=configuration
set CONF=conf/%SERVER_NAME%-bootstrap.yml
...
set JAVA_OPT=%JAVA_OPT% -XX:+PrintGCDetails -XX:+PrintGCTimeStamps -XX:+PrintGCDateStamps
set JAVA_OPT=%JAVA_OPT% -Xloggc:logs/gc/%SERVER_NAME%-gc.log  
